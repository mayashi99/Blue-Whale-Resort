    ...
    <div className="w-full overflow-x-hidden" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <section className="relative h-[75vh] min-h-[520px] overflow-hidden">
        ...
        <div className="relative z-10 flex h-full flex-col justify-center px-8 sm:px-16 lg:px-24 max-w-[1400px] mx-auto">
          ...
          {/* pill badge */}
          <div className="mb-8 inline-flex w-fit items-center gap-2 rounded-full bg-white/10 backdrop-blur-md border border-white/20 px-4 py-2">
            <span className="h-1.5 w-1.5 rounded-full bg-[#52b5a8] animate-pulse" />
            <span className="text-[11px] font-medium tracking-[0.22em] text-white/90 uppercase">
              Kalpitiya · Sri Lanka
            </span>
          </div>
      ...
      <div className="bg-[#f0faf8] border-b border-[#2a9d8f]/15">
        <div className="mx-auto max-w-6xl px-6 py-10 flex flex-col sm:flex-row items-center justify-between gap-6">
          <p className="text-sm text-[#0b3d3a]/60 max-w-lg leading-relaxed text-center sm:text-left">
            Awarded Sri Lanka's finest boutique beach resort — 160 km north of Colombo,
            steps from the Indian Ocean.
          </p>
          <div className="flex items-center gap-2 flex-shrink-0">
            {[...Array(5)].map((_, i) => <FaStar key={i} className="text-[#e76f51] text-sm" />)}
            <span className="ml-2 text-xs font-semibold text-[#0b3d3a]/50 tracking-wide">5.0 · 200+ Reviews</span>
          </div>
        </div>
      </div>
